...
from .forms import PaymentForm, CargoForm
...
class ShopView(View):
    def get(self, request):
        ...
        response = requests.get("http://127.0.0.1:8032/client/token/verify", headers=headers)
        ...
        if response.status_code == 200:
            ...
            return render(request, "shop.html", 'furniture not found')
...
class LoginView(View):
    ...
    def post(self, request):
        ...
        url = "http://127.0.0.1:8032/client/login/"
        data = {
            "username": username,
            "password": password,
        }
...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        url = "http://127.0.0.1:8032/client/register/"
        data = {
